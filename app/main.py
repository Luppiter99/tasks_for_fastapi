...
# Описание проекта:
# Вам необходимо создать API-сервис для управления пользователями и
# задачами с использованием FastAPI/Django. Сервис должен предоставлять
# возможность создания, чтения, обновления и удаления (CRUD)
# пользователей и задач. Кроме того, необходимо реализовать аутентификацию
# и авторизацию пользователей, а также написать тесты для всех реализованных
# функций
...
#      - Название (строка)
#      - Описание (строка)
#      - Статус (строка, возможные значения: "новая", "в процессе",
# "завершена")
...
#    - Реализовать защиту маршрутов, чтобы только аутентифицированные
# пользователи могли создавать, обновлять и удалять задачи
...
# 5. Документация:
#    - Автоматически сгенерированная документация API с использованием
# Swagger (доступна по адресу `/docs`)

# 6. Тестирование:
#    - Написать тесты для всех реализованных функций, включая:
#      - Тесты для проверки корректности работы CRUD операций для пользователей
# и задач
...
#     - Создать docker-compose файл для простого развёртывания базы данных и
# приложения
